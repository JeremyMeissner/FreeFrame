...
namespace FreeFrame.Lib.IconsFontAwesome
{
    internal class FontAwesome5
    {
        public static const string FontIconFileNameRegular = "fa-regular-400.ttf";
        public static const string FontIconFileNameSolid = "fa-solid-900.ttf";
